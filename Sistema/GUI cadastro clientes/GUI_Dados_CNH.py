...
class Gui():
    def __init__(self):
        ...
        self.entNumero_CNH = Entry(self.window, textvariable=self.txtNumero_CNH)
    ...
    def configure_layout(self):
        ...
        self.btnViewAll.grid(row=8, column=0, columnspan=2)#columnspan para fazer com que o objeto ocupe mais de uma linha.
